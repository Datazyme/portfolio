<script>
  export let y;
  let tabs = [
    {name:'Progects', link:'#projects'},
    {name:'About me', link:'#about'},
    //{name:'Progects', '#projects'},
  ]
</script>
...
<header class={"sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid " + (
  ...
  <h1 class="font-medium">
    <b class="font-bold poppins">Anastasia</b> Kuzmin
  </h1>
  ...
  <a href="https://www.cbc.ca/news" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
