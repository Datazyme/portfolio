...
>
    ...
    >
        <button
            on:click={goTop}
            class="ml-auto rounded-full aspect-squre bg-slate-900 text-violet-400 px-3 sm:px-4 hover:bg-slate-800 cursor-pointer aspect-square grid place-items-center"
        >
